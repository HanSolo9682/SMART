...
# Usage examples:
#   GPUS=0,1 TRAIN_DATA=/path/to/colpali_train_set bash training_visdoc_8b.sh
#   DEBUG_PRINT_BATCH=1 DEBUG_PRINT_BATCH_EXIT=1 GPUS=0 bash training_visdoc_8b.sh
...
TRAIN_DATA=${TRAIN_DATA:-/XXX/colpali_train_set}
OUTPUT_ROOT=${OUTPUT_ROOT:-./outputs/qwen3_vl_visdoc_8b_only_residual}
MODEL_NAME_OR_PATH=${MODEL_NAME_OR_PATH:-Qwen/Qwen3-VL-Embedding-8B}
CACHE_DIR=${CACHE_DIR:-/XXX/.cache/}
IMAGE_CACHE_DIR=${IMAGE_CACHE_DIR:-/XXX/.cache/}
