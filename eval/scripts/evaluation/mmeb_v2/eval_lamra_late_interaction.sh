...
# MODEL_NAME="$1"
MODEL_NAME=/home/zeyi/harrisz/AttentiveRetrieval/checkpoints/qwen3-vl-2b_visdoc_baseline_convert_1e-4
MODEL_BASENAME=$(basename "$MODEL_NAME")

BATCH_SIZE="${BATCH_SIZE:-32}"
MODALITIES=("visdoc")
DATA_BASEDIR=/XXX/MMEB-V2
OUTPUT_BASEDIR=/XXX/result_lamra_baseline_convert_1e-4
...
for MODALITY in "${MODALITIES[@]}"; do
    ...
    cmd="CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES torchrun \
        ...
        --max_restarts=0 \
        -m src.evaluation.mmeb_v2.eval_lamra_late_interaction \
        --normalize true \
